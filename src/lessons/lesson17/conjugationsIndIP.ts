...
const lesson17ConjugationsIndIP: LessonType = {
  id: 'lesson17-conjugations-indip',
  name: 'Les 17 – Indicatief imperfectum passief',
  type: 'woordenschat',
  active: false,
  questions
}
export default lesson17ConjugationsIndIP
