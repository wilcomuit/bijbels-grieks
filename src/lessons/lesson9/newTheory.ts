const questions: Array<MixedQuestionType> = [
  ...
  },
  {
    question: 'γενεά',
    answers: ['generatie'],
    explanation: '(genealogie)',
    type: 'woordenschat'
  },
  {
    question: 'ἐκκλησία',
    answers: ['vergadering', 'kerk'],
    explanation: '(ecclesiologie)',
    type: 'woordenschat'
  },
  {
    question: 'ἐξουσία',
  ...
  },
  {
    question: 'καρδια',
    answers: ['hart'],
    explanation: '(cardiografie, cardioloog)',
    type: 'woordenschat'
  },
  {
    question: 'μαρτυρία',
    answers: ['getuigenis'],
    explanation: '(martelaar)',
    type: 'woordenschat'
  },
  {
    question: 'μετάνοια',
  ...
  },
  {
    question: 'οἰκια',
    answers: ['huis'],
    explanation: '(economie, econoom)',
    type: 'woordenschat'
  },
  {
    question: 'παρουσία',
    answers: ['komst'],
    explanation: '(parousie)',
    type: 'woordenschat'
  },
  {
    question: 'πέτρα',
  ...
  },
  {
    question: 'σοφία',
    answers: ['wijsheid'],
    explanation: '(filosofie, Sofie)',
    type: 'woordenschat'
  },
  {
    question: 'σωτηρία',
    answers: ['heil', 'redding'],
  ...
  },
  {
    question: 'γλῶσσα',
    answers: ['tong'],
    explanation: '(glossolalie)',
    type: 'woordenschat'
  },
  {
    question: 'δόξα',
    answers: ['glorie', 'heerlijkheid'],
    explanation: '(doxologie)',
    type: 'woordenschat'
  },
  {
    question: 'θάλασσα',
...
const lesson9NewTheory: LessonType = {
  id: 'lesson9-theory-new',
  name: 'Les 9 – Volledige theorie',
  type: 'woordenschat',
  active: false,
  questions
}
export default lesson9NewTheory
