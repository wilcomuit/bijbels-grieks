const questions: Array<QuestionType> = [
    ...
    },
    {
        question: "ἀκούω",
        answers: ["ik hoor"],
        explanation: "(+ acc. van de zaak die ik hoor, maar + gen. van de persoon die ik hoor (akoestiek))",
        type: "woordenschat"
    },
    {
        question: "ὑπακούω",
...
const lesson13Vocabulary: LessonType = {
...
export default lesson13Vocabulary