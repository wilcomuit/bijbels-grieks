const questions: Array<QuestionType> = [
    ...
    {
      question: "κρίνει",
      answers: ["hij oordeelt", "zij oordeelt", "het oordeelt", "hij scheidt", "zij scheidt", "het scheidt", "hij onderscheidt", "zij onderscheidt", "het onderscheidt"],
    ...
    },
    {
      ...
      explanation: "hij/zij/het maakt los (analyse, katalyse, katalysator, vgl. Ned.: los, verlossen)",
      type: "woordenschat"
    },
    {
      question: "μένει",
      answers: ["hij blijft", "zij blijft", "het blijft", "hij begeleidt", "zij begeleidt", "het begeleidt", "hij houdt een optocht", "zij houdt een optocht", "het houdt een optocht"],
      explanation: "hij/zij/het blijft, hij/zij/het begeleidt, hij/zij/het houdt een optocht (Eng.: I remain)",
      type: "woordenschat"
    },
    {
      question: "πέμπει",
