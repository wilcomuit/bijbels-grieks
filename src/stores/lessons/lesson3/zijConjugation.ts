const questions: Array<QuestionType> = [
    ...
    {
      question: "κρίνουσιν",
      answers: ["ze oordelen", "zij oordelen", "ze scheiden", "zij scheiden", "ze onderscheiden", "zij onderscheiden"],
    ...
    {
      question: "μένουσιν",
      answers: ["ze blijven", "zij blijven", "ze begeleiden", "zij begeleiden", "ze houden een optocht", "zij houden een optocht"],
...
export default lesson3ZijConjugation