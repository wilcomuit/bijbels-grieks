const questions: Array<QuestionType> = [
    ...
    },
    {
      question: "ἴδιος",
      answers: ["eigen"],
      explanation: "(normaal gebruikt met het lidwoord en zonder persoonlijk voornaamwoord. ὁ ἴδιος betekent dus 'mijn eigen', 'uw eigen' enz. volgens de context) (idioom = taaleigen)",
      type: "woordenschat"
    },
    {
      question: "ἰσχυρός",
